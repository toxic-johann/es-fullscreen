 ...
 * Released under MIT
 * Built ad Sat Jan 19 2019 00:12:47 GMT+0800 (China Standard Time)
 */

import _typeof from '@babel/runtime/helpers/typeof';
import _classCallCheck from '@babel/runtime/helpers/classCallCheck';
import _createClass from '@babel/runtime/helpers/createClass';
import { isElement, isFunction, isEvent, isPosterityNode, defined } from 'toxic-predicate-functions';
...
function dispatchEvent(element, name) {
  ...
  if (!_isPlainObject(event) && !isEvent(event)) {
