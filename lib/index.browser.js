 ...
 * Released under MIT
 * Built ad Wed Oct 17 2018 22:39:53 GMT+0800 (China Standard Time)
 */
...
(function (global, factory) {
	...
	function isString$1(value) {
	  return typeof value == 'string' ||
	    (!isArray_1$1(value) && isObjectLike_1$1(value) && _baseGetTag$1(value) == stringTag$1);
	}
	...
	function isPlainObject$1(value) {
	  if (!isObjectLike_1$1(value) || _baseGetTag$1(value) != objectTag$1) {
	    return false;
	  }
	...
	function native(target, name) {
	  ...
	  if (name && !isString_1$1(name)) {
	    option = name;
	  }

	  if (isString_1$1(target)) {
	    name = target;
	  }
	...
	function dispatchEvent(element, name) {
	  ...
	  if (!isPlainObject_1$1(event) && !isEvent(event)) {
