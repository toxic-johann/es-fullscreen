...
function dispatchEvent(element, name) {
  ...
  if (!toxicPredicateFunctions.isObject(event) && !toxicPredicateFunctions.isEvent(event)) throw new Error("We can't create an object on this browser, please report to author");
  /* istanbul ignore else  */
